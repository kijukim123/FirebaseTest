...
public class PDA_AND_MULTI_MERGE_POPUP extends BaseActivity {

    String Log_menuID= "PDA_AND_MULTI_MERGE" ;   // 로그 기록 용 화면 이름
    String Log_action = "MERGE" ;      // 로그 기록 용 action 이름
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PDA_AND_MULTI_MERGE_POPUP.this, PDA_AND_MERGE.class);
                setResult(0, intent);
